        ...
        <main>
            <table border="1" cellpadding="8" cellspacing="0" style="width:100%;border-collapse:collapse;margin-bottom:2rem">
                <thead style="background:#f1f5f9">
                    <tr>
                        <th style="padding:12px;text-align:left;font-weight:600;color:#1f2937">ID</th>
                        <th style="padding:12px;text-align:left;font-weight:600;color:#1f2937">Nama Jenis Hewan</th>
                ...
                <tbody>
                    ...
                    <tr style="border-bottom:1px solid #e5e7eb">
                        <td style="padding:12px;color:#374151">{{ $jenis->id }}</td>
                        <td style="padding:12px;color:#374151">{{ $jenis->nama_jenis_hewan }}</td>
                        <td style="padding:12px;color:#374151">{{ $jenis->deskripsi }}</td>
                    </tr>
                    @endforeach
                </tbody>
            </table>
