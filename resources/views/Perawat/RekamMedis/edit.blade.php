    ...
    <div class="row mb-2">
        ...
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-end">
                ...
                <li class="breadcrumb-item"><a href="{{ route('perawat.rekam_medis.index') }}">Rekam Medis</a></li>
                ...
                <form action="{{ route('perawat.rekam_medis.update', $rekamMedis->idrekam_medis) }}" method="POST">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('id_pet') is-invalid @enderror" id="id_pet" name="id_pet" required>
                                <option value="">-- Pilih Pet --</option>
                                @foreach($pets as $pet)
                                    <option value="{{ $pet->id_pet }}" {{ (old('id_pet', $rekamMedis->id_pet) == $pet->id_pet) ? 'selected' : '' }}>
                                        {{ $pet->nama_pet }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('keluhan') is-invalid @enderror" id="keluhan" name="keluhan" rows="3" required>{{ old('keluhan', $rekamMedis->keluhan) }}</textarea>
                            @error('keluhan')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('diagnosa') is-invalid @enderror" id="diagnosa" name="diagnosa" rows="3">{{ old('diagnosa', $rekamMedis->diagnosa) }}</textarea>
                            @error('diagnosa')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('id_perawat') is-invalid @enderror" id="id_perawat" name="id_perawat">
                                <option value="">-- Pilih Perawat --</option>
                                @foreach($perawats as $perawat)
                                    <option value="{{ $perawat->id_perawat }}" {{ (old('id_perawat', $rekamMedis->id_perawat) == $perawat->id_perawat) ? 'selected' : '' }}>
                                        {{ $perawat->name }}
                                    </option>
                                @endforeach
                            </select>
