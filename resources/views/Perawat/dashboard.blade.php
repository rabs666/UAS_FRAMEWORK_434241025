      ...
      <div class="row">
        ...
        <div class="col-lg-4 col-6">
          <div class="small-box text-bg-primary">
            ...
            <a href="{{ route('perawat.pasien.index') }}" class="small-box-footer link-light link-underline-opacity-0 link-underline-opacity-50-hover">
        ...
        <div class="col-lg-4 col-6">
          <div class="small-box text-bg-success">
            ...
            <a href="{{ route('perawat.rekam_medis.index') }}" class="small-box-footer link-light link-underline-opacity-0 link-underline-opacity-50-hover">
        ...
        <div class="col-lg-4 col-6">
          <div class="small-box text-bg-warning">
            ...
            <a href="{{ route('perawat.detail_rekam_medis.index') }}" class="small-box-footer link-dark link-underline-opacity-0 link-underline-opacity-50-hover">
              Lihat Data <i class="bi bi-link-45deg"></i>
            </a>
          </div>
        </div>
          ...
          <div class="card">
            ...
            <div class="card-body">
              <div class="alert alert-info mb-3">
                <i class="bi bi-info-circle"></i> Anda login sebagai <strong>Perawat</strong> pada sistem Klinik Hewan.
              </div>
              ...
              <div class="row">
                <div class="col-md-6">
                  <ul class="list-group">
                    ...
                    <li class="list-group-item"><i class="bi bi-pencil-square text-success"></i> <strong>CRUD</strong> Rekam Medis</li>
                  </ul>
                </div>
                <div class="col-md-6">
                  <ul class="list-group">
                    <li class="list-group-item"><i class="bi bi-eye text-primary"></i> <strong>View</strong> Detail Rekam Medis</li>
                    <li class="list-group-item"><i class="bi bi-person-circle text-info"></i> <strong>View</strong> Profil Perawat</li>
                  </ul>
                </div>
              </div>
            </div>
